...
public abstract class AccountCreator
{
  ...
  protected abstract Balance createMainBalance(decimal initialPoints, decimal minimalPoints, decimal multiplier);
  protected abstract Balance createTrainingBalance(decimal initialPoints, decimal minimalPoints, decimal multiplier);
